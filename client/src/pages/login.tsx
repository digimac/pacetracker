  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden bg-background">
      ...
      <div className="relative z-10 w-full max-w-sm flex flex-col items-center">
        ...
        {headline && (
          <h1 className="font-black tracking-tight uppercase text-center mb-2 text-white drop-shadow-lg w-full" style={{ fontFamily: '"vandertak-capslock-side", sans-serif', fontWeight: 400, fontSize: '2.75rem', lineHeight: '2.5rem', color: '#85FF00' }}>
            {headline}
          </h1>
        )}

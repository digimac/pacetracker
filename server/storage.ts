...
export class DrizzleStorage implements IStorage {
  ...
  async updateUserProfile(userId: number, updates: { firstName?: string | null; lastName?: string | null; city?: string | null; region?: string | null; country?: string | null; category?: string | null; phone?: string | null; smsOptIn?: boolean }): Promise<User | undefined> {
